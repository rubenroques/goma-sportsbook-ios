...
class MatchWidgetCollectionViewCell: UICollectionViewCell {
    ...
    @IBOutlet weak var horizontalMatchInfoBaseView: UIView!
    lazy var horizontalMatchInfoView: HorizontalMatchInfoView = Self.createHorizontalMatchInfoView()

    @IBOutlet weak var outrightNameBaseView: UIView!
    @IBOutlet weak var outrightNameLabel: UILabel!

    @IBOutlet weak var headerLineStackView: UIStackView!
    ...
    // Outrights
    @IBOutlet weak var outrightBaseView: UIView!
    @IBOutlet weak var outrightSeeLabel: UILabel!

    // Boosted odds View
    var boostedTopRightCornerBaseView = UIView()
    var boostedTopRightCornerLabel = UILabel()
    var boostedTopRightCornerImageView = UIImageView()
    let boostedBackgroungImageView = UIImageView()

    // Market name view
    @IBOutlet weak var marketNameView: UIView!
    @IBOutlet weak var marketNameInnerView: UIView!
    ...
    var oldTitleBoostedOddLabel: UILabel = {
        var label = UILabel()
    ...
    var oldValueBoostedOddLabel: UILabel = {
        var label = UILabel()
    ...
    var newTitleBoostedOddLabel: UILabel = {
        var label = UILabel()
        label.font = AppFont.with(type: .bold, size: 8)
        label.textAlignment = .center
        label.translatesAutoresizingMaskIntoConstraints = false
    ...
    var newValueBoostedOddLabel: UILabel = {
        var label = UILabel()
        label.font = AppFont.with(type: .bold, size: 14)
        label.textAlignment = .center
        label.translatesAutoresizingMaskIntoConstraints = false
    ...
    // =============================
    //
    @IBOutlet weak var homeBoostedOddValueBaseView: UIView!
    @IBOutlet weak var homeNewBoostedOddValueLabel: UILabel!
    @IBOutlet weak var homeBoostedOddArrowView: BoostedArrowView!
    @IBOutlet weak var homeOldBoostedOddValueLabel: UILabel!

    @IBOutlet weak var drawBoostedOddValueBaseView: UIView!
    @IBOutlet weak var drawNewBoostedOddValueLabel: UILabel!
    @IBOutlet weak var drawBoostedOddArrowView: BoostedArrowView!
    @IBOutlet weak var drawOldBoostedOddValueLabel: UILabel!

    @IBOutlet weak var awayBoostedOddValueBaseView: UIView!
    @IBOutlet weak var awayNewBoostedOddValueLabel: UILabel!
    @IBOutlet weak var awayBoostedOddArrowView: BoostedArrowView!
    @IBOutlet weak var awayOldBoostedOddValueLabel: UILabel!
    ...
    @IBOutlet weak var seeAllBaseView: UIView!
    @IBOutlet weak var seeAllLabel: UILabel!

    //
    // Design Constraints
    @IBOutlet weak var topMarginSpaceConstraint: NSLayoutConstraint!
    @IBOutlet weak var bottomMarginSpaceConstraint: NSLayoutConstraint!
    @IBOutlet weak var leadingMarginSpaceConstraint: NSLayoutConstraint!
    @IBOutlet weak var trailingMarginSpaceConstraint: NSLayoutConstraint!

    @IBOutlet weak var headerHeightConstraint: NSLayoutConstraint!
    @IBOutlet weak var teamsHeightConstraint: NSLayoutConstraint!
    ...
    //
    @IBOutlet weak var mainContentBaseView: UIView!
    ...
    @IBOutlet weak var boostedOddBottomLineView: UIView!
    ...
    var contentRedesignBaseView: UIView = {
        var view = UIView()
    ...
    var topSeparatorAlphaLineView: FadingView = {
    ...
    var detailedScoreView: ScoreView = {
    ...
    lazy var awayNameLabel: UILabel = {
        var label = UILabel()
        label.font = AppFont.with(type: .bold, size: 16)
        label.textAlignment = .left
        label.translatesAutoresizingMaskIntoConstraints = false
    ...
    var homeServingIndicatorView: UIView = {
        var view = UIView()
    ...
    var awayServingIndicatorView: UIView = {
        var view = UIView()
        view.backgroundColor = .white
        view.translatesAutoresizingMaskIntoConstraints = false
        return view
    ...
    override func awakeFromNib() {
        ...
        // Call setupSubviews to initialize the horizontalMatchInfoView
        self.setupSubviews()
    ...
    func adjustMarketNameView(isShown: Bool) {
...
extension MatchWidgetCollectionViewCell {
    ...
    func configure(withViewModel viewModel: MatchWidgetCellViewModel) {
        ...
        // Subscribe to horizontalMatchInfoViewModelPublisher
...
extension MatchWidgetCollectionViewCell {
    ...
    func animateBorderColor(view: UIView, color: UIColor, duration: Double) {
...
extension MatchWidgetCollectionViewCell {
    ...
    @IBAction func didLongPressCard() {
...
extension MatchWidgetCollectionViewCell {
    ...
    static func createHorizontalMatchInfoView() -> HorizontalMatchInfoView {
    ...
    func setupSubviews() {
        // Add horizontalMatchInfoView to the view hierarchy
    ...
    func initConstraints() {
        // Set up constraints for horizontalMatchInfoView
        NSLayoutConstraint.activate([
            self.horizontalMatchInfoView.topAnchor.constraint(equalTo: self.horizontalMatchInfoBaseView.topAnchor),
            self.horizontalMatchInfoView.leadingAnchor.constraint(equalTo: self.horizontalMatchInfoBaseView.leadingAnchor),
            self.horizontalMatchInfoView.trailingAnchor.constraint(equalTo: self.horizontalMatchInfoBaseView.trailingAnchor),
            self.horizontalMatchInfoView.bottomAnchor.constraint(equalTo: self.horizontalMatchInfoBaseView.bottomAnchor)
        ])
    }

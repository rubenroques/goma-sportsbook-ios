//
//  BoostedOddsCollectionViewCell.swift
//  Sportsbook
//
...
class BoostedOddsCollectionViewCell: UICollectionViewCell {
...
// MARK: - Factory Extension (implement in BoostedOddsCollectionViewCell+Factory.swift)
extension BoostedOddsCollectionViewCell {
    // Factory methods for UI components
}

// MARK: - Layout Extension (implement in BoostedOddsCollectionViewCell+Layout.swift)
extension BoostedOddsCollectionViewCell {
    // Layout methods
}

// MARK: - Configuration Extension (implement in BoostedOddsCollectionViewCell+Configuration.swift)
extension BoostedOddsCollectionViewCell {
    // Configuration methods
}

// MARK: - Interactions Extension (implement in BoostedOddsCollectionViewCell+Interactions.swift)
extension BoostedOddsCollectionViewCell {
    // Interaction methods
}

// MARK: - Styling Extension (implement in BoostedOddsCollectionViewCell+Styling.swift)
extension BoostedOddsCollectionViewCell {
    // Styling methods
}

// MARK: - Animation Extension (implement in BoostedOddsCollectionViewCell+Animations.swift)
extension BoostedOddsCollectionViewCell {
    // Animation methods
}

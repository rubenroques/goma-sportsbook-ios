...
class MyTicketCardView: NibView {
    ...
    @IBOutlet private weak var shareButtonPlaceholderView: UIView!
    ...
    override func commonInit() {
        ...
        //
        self.shareButtonPlaceholderView.isHidden = false
    ...
    private func setupShareButton() {
        // Clear existing subviews from placeholder
        shareButtonPlaceholderView.subviews.forEach { $0.removeFromSuperview() }
    ...
    func setupPartialCashoutSlider() {
        ...
        let minCashoutStep = 0.01
        
        let minValue: CGFloat = minCashoutStep
        let maxValue: CGFloat = maxSliderStake
        let middleValue: CGFloat = maxValue/2 // Default slider place

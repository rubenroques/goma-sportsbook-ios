...
extension MatchWidgetCollectionViewCell {
    ...
    func configure(withViewModel viewModel: MatchWidgetCellViewModel) {
        ...
        Publishers.CombineLatest(viewModel.matchWidgetStatusPublisher, viewModel.matchWidgetTypePublisher)
        ...
        Publishers.CombineLatest(viewModel.matchWidgetStatusPublisher, viewModel.isLiveCardPublisher)
        ...
        viewModel.matchWidgetTypePublisher
            .removeDuplicates()
            .receive(on: DispatchQueue.main)
        ...
        Publishers.CombineLatest(
            ...
            viewModel.oldBoostedOddOutcomePublisher
        )
        .receive(on: DispatchQueue.main)
        ...
        Publishers.CombineLatest4(viewModel.mainMarketNamePublisher,
                                  viewModel.matchWidgetTypePublisher,
                                  viewModel.matchWidgetStatusPublisher,
...
//            }
        ...
        Publishers.CombineLatest3(viewModel.matchWidgetTypePublisher,

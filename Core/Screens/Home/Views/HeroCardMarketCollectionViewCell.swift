...
extension HeroCardMarketCollectionViewCell {
    ...
    private func initConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            self.homeTeamLabel.leadingAnchor.constraint(equalTo: self.baseView.leadingAnchor, constant: 5),
            ...
            self.awayTeamLabel.leadingAnchor.constraint(equalTo: self.baseView.leadingAnchor, constant: 5),
            ...
            self.dateLabel.trailingAnchor.constraint(equalTo: self.baseView.trailingAnchor, constant: -5),
            self.dateLabel.topAnchor.constraint(equalTo: self.baseView.topAnchor, constant: 10),
            
            self.timeLabel.trailingAnchor.constraint(equalTo: self.baseView.trailingAnchor, constant: -5),
            self.timeLabel.topAnchor.constraint(equalTo: self.dateLabel.bottomAnchor, constant: 5),
            
            self.oddsStackView.leadingAnchor.constraint(equalTo: self.baseView.leadingAnchor, constant: 5),
            self.oddsStackView.trailingAnchor.constraint(equalTo: self.baseView.trailingAnchor, constant: -5),
            self.oddsStackView.topAnchor.constraint(equalTo: self.awayTeamLabel.bottomAnchor, constant: 10),
            self.oddsStackView.heightAnchor.constraint(equalToConstant: 40),
            self.oddsStackView.bottomAnchor.constraint(lessThanOrEqualTo: self.baseView.bottomAnchor, constant: -5),

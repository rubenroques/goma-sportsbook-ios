...
class BetSelectionStateTableViewCell: UITableViewCell {
    ...
    private lazy var betAmountValueLable: UILabel = Self.createBetAmountValueLabel()
    ...
    func setupWithTheme() {
        ...
        self.betAmountValueLable.textColor = UIColor.App.textPrimary
...
extension BetSelectionStateTableViewCell {
    ...
    private func setupSubviews() {
        ...
        self.bottomValuesStackView.addArrangedSubview(self.betAmountValueLable)

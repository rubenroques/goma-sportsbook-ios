//
//  NewsPreviewCollectionViewCell.swift
//  Sportsbook
//
...
class NewsPreviewCellViewModel {

    var newsItemFeedContent: NewsItemFeedContent

    init(newsItemFeedContent: NewsItemFeedContent) {
        self.newsItemFeedContent = newsItemFeedContent
    }

    func imageURL() -> URL? {
        if let urlString = newsItemFeedContent.imageURL {
    ...
    var title: String {
        self.newsItemFeedContent.title ?? ""
    }

    var subtitle: String {
        self.newsItemFeedContent.description ?? ""
    }

    var externalLinkURL: URL? {
        if let streamURLString = newsItemFeedContent.linkURL {
...
class NewsPreviewCollectionViewCell: UICollectionViewCell {

    var didTapNewsPreviewCellAction: ((NewsPreviewCellViewModel) -> Void) = { _ in }
    ...
    private var viewModel: NewsPreviewCellViewModel?
    ...
    func configure(withViewModel viewModel: NewsPreviewCellViewModel) {
    ...
    @objc private func didTapBaseView() {
        if let viewModel = self.viewModel {
            self.didTapNewsPreviewCellAction(viewModel)
        }
    }

}

extension NewsPreviewCollectionViewCell {
    ...
    private func setupSubviews() {
        ...
        let iconImageView = UIImageView(image: UIImage(named: "news_corner_icon"))

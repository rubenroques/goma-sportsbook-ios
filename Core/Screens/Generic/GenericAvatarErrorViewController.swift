//
//  GenericAvatarErrorViewController.swift
//  Sportsbook
//
...
class GenericAvatarErrorViewController: UIViewController {
...
extension GenericAvatarErrorViewController {
    ...
    private static func createSubtitleLabel() -> UILabel {
        ...
        label.text = localized("deposit_error_message")
        label.textAlignment = .center
        label.numberOfLines = 0
        label.translatesAutoresizingMaskIntoConstraints = false
        return label

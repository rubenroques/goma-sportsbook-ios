...
class EventSSWampMessage: SSWampMessage {
    ...
    func marshal() -> [Any] {
        var marshalled: [Any] = [SSWampMessages.event.rawValue, self.subscription, self.publication, self.details]

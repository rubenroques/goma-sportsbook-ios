...
class HomeAwayCardStatsView: NibView {
    ...
    func setupWithTheme() {
        ...
        self.homeProgressBar.trackTintColor = UIColor.App.scroll
        self.homeProgressBar.progressTintColor = UIColor.App.statsHome

        self.awayValueLabel.textColor = UIColor.App.textPrimary
        self.awayProgressBar.trackTintColor = UIColor.App.scroll
        self.awayProgressBar.progressTintColor = UIColor.App.statsAway

...
class HomeAwayCardStatsView: NibView {
    ...
    func setupWithTheme() {
        ...
        self.homeValueLabel.textColor = UIColor.App2.textPrimary
        self.homeProgressBar.trackTintColor = UIColor.App2.backgroundTertiary
        self.homeProgressBar.progressTintColor = UIColor(hex: 0xD99F00)

        self.awayValueLabel.textColor = UIColor.App2.textPrimary
        self.awayProgressBar.trackTintColor = UIColor.App2.backgroundTertiary

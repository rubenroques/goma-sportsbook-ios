...
class EditAlertView: NibView {
    ...
    func setupWithTheme() {
        ...
        alertImageView.backgroundColor = UIColor.Core.backgroundDarkProfile

        alertLabel.textColor = UIColor.Core.headingMain

        alertTextLabel.textColor = UIColor.Core.headingMain

        closeButton.backgroundColor = UIColor.Core.backgroundDarkProfile
        closeButton.tintColor = UIColor.Core.headerTextFieldGray

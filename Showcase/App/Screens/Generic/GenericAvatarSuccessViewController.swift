//
//  GenericAvatarSuccessViewController.swift
//  Sportsbook
//
//  Created by André Lascas on 29/08/2023.
//

import UIKit

class GenericAvatarSuccessViewController: UIViewController {
    ...
    private func setupWithTheme() {
        ...
        self.shapeView.colors = [(UIColor(red: 1.0 / 255.0, green: 2.0 / 255.0, blue: 91.0 / 255.0, alpha: 1), NSNumber(0.0)),
                                              (UIColor(red: 64.0 / 255.0, green: 76.0 / 255.0, blue: 255.0 / 255.0, alpha: 1), NSNumber(1.0))]

        self.shapeView.startPoint = CGPoint(x: 0.0, y: 0.0)
        self.shapeView.endPoint = CGPoint(x: 2.0, y: 0.0)

        self.infoContainerGradientView.colors = [(UIColor(red: 1.0 / 255.0, green: 2.0 / 255.0, blue: 91.0 / 255.0, alpha: 1), NSNumber(0.0)),
                                              (UIColor(red: 64.0 / 255.0, green: 76.0 / 255.0, blue: 255.0 / 255.0, alpha: 1), NSNumber(1.0))]
...
extension GenericAvatarSuccessViewController {
    ...
    private static func createAvatarImageView() -> UIImageView {
        ...
        imageView.image = UIImage(named: "avatar_success")
    ...
    private static func createSubtitleLabel() -> UILabel {
        ...
        label.text = localized("deposit_success_message")
        label.textAlignment = .center
        label.numberOfLines = 0
        label.translatesAutoresizingMaskIntoConstraints = false
        return label

//
//  SuggestedBetSliderViewController.swift
//  Sportsbook
//
...
class SuggestedBetSliderViewController: UIViewController {
    ...
    private var viewModel: SuggestedBetSliderViewModel
    ...
    init(viewModel: SuggestedBetSliderViewModel) {
    ...
    override func viewDidLoad() {
        ...
        self.collectionView.register(SuggestedBetCardCollectionViewCell.self, forCellWithReuseIdentifier: SuggestedBetCardCollectionViewCell.identifier)
...
//        }
    ...
    private func setupPublishers() {
        // Publisher setup removed - social features disabled
    }
...
extension SuggestedBetSliderViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension SuggestedBetSliderViewController {

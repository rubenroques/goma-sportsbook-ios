//
//  SuggestedBetSelectionView.swift
//  Sportsbook
//
...
class SuggestedBetSelectionView: UIView {
    ...
    func configure(withSuggestedBetSelectionViewModel viewModel: SuggestedBetSelectionViewModel) {
...
//
extension SuggestedBetSelectionView {

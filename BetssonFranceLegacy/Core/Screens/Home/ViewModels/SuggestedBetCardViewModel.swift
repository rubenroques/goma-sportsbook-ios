//
//  SuggestedBetCardViewModel.swift
//  Sportsbook
//
...
class SuggestedBetCardViewModel {
    ...
    var selectionViewModels: [SuggestedBetSelectionViewModel] = []
    ...
    private func generateSelectionViewModels() {
        ...
        case .featuredTip(let featuredTip):
            self.selectionViewModels = (featuredTip.selections ?? []).map(SuggestedBetSelectionViewModel.init(featuredTipSelection:))
            self.selectionViewModels = []
            for selection in (featuredTip.selections ?? []) {
                self.selectionViewModels.append(SuggestedBetSelectionViewModel.init(featuredTipSelection: selection))
            }
            
        case .suggestedBetslip(let suggestedBetslip):
            self.selectionViewModels = []
            for (_, selection) in suggestedBetslip.selections.enumerated() {
                self.selectionViewModels.append(SuggestedBetSelectionViewModel.init(suggestedBetslipSelection: selection))
            }
...
class SuggestedBetSelectionViewModel {

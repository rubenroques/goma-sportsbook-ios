//
//  BoostedMatchWidgetCollectionViewCell+Interactions.swift
//  Sportsbook
//
...
extension BoostedMatchWidgetCollectionViewCell {

    // MARK: - Setup Gesture Recognizers
    func setupGestureRecognizers() {
        // Remove the favorites button tap gesture recognizer since it's handled by MatchHeaderView

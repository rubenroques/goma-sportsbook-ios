...
struct PreviewModelsHelper {
    ...
    // MARK: - Competition Groups

    /// Creates a mock popular competitions group
    static func createPopularCompetitionsGroup() -> CompetitionGroup {
        return CompetitionGroup(
            id: "popular1",
            name: "Popular Competitions",
            aggregationType: .popular,
            competitions: [
                createPremierLeagueCompetition(),
                createLaLigaCompetition(),
                createSerieACompetition()
            ],
            country: nil
        )
    }

    /// Creates a mock region-based competitions group for UK
    static func createUKCompetitionsGroup() -> CompetitionGroup {
        return CompetitionGroup(
            id: "uk1",
            name: "United Kingdom",
    ...
    // MARK: - Additional Competition Groups

    /// Creates a mock North American competitions group
    static func createNorthAmericanCompetitionsGroup() -> CompetitionGroup {
        return CompetitionGroup(
            id: "na1",
            name: "North American Leagues",
            aggregationType: .region,
            competitions: [
                createNBACompetition(),
                createNHLCompetition()
            ],
            country: Country(
                name: "United States",
    ...
    /// Creates a mock international competitions group
    static func createInternationalCompetitionsGroup() -> CompetitionGroup {
        return CompetitionGroup(
            id: "int1",
            name: "International Competitions",
            aggregationType: .popular,
            competitions: [
                createSixNationsCompetition(),
                createIPLCompetition()
            ],
            country: nil
        )
    }

...
extension ServiceProviderModelMapper {
    ...
    static func promotionInfo(fromInternalPromotionInfo promotionInfo: ServicesProvider.PromotionInfo) -> PromotionInfo {
        ...
        return PromotionInfo(id: promotionInfo.id,
    ...
    static func staticPage(fromInternalStaticPage staticPage: ServicesProvider.StaticPage?) -> StaticPage? {
        ...
        if let staticPage {
            ...
            return StaticPage(title: staticPage.title,
                              slug: staticPage.slug,
                              headerImageUrl: staticPage.headerImageUrl,
                              isActive: staticPage.isActive,
                              usedForPromotions: staticPage.usedForPromotions,
                              platform: staticPage.platform,
                              status: staticPage.status,
                              userType: staticPage.userType,
                              startDate: staticPage.startDate,
                              endDate: staticPage.endDate,
                              sections: sections,
                              terms: terms)
        }
    ...
    static func termItem(fromInternalTermItem term: ServicesProvider.TermItem) -> TermItem {
        ...
        return TermItem(displayType: self.termsDisplayType(fromInternalTermsDisplayType: term.displayType),

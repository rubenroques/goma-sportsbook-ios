...
public enum EveryMatrixError: Error, Hashable {
    
    case autentication(error: EveryMatrixAuthenticationError)
    
    case invalidRequestFormat
    /// Unexpected Deallocaion
...
public enum EveryMatrixAuthenticationError: Error, Hashable {
    ...
    case invalidResponseDecoded(String)
    /// Unknown error
    case unknown(String)
    ...
    public var localizedDescription: String {
        ...
        case .invalidResponseDecoded(let message):

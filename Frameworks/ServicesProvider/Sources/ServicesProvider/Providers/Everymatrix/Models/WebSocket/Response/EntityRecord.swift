...
extension EveryMatrix {
    enum EntityRecord: Codable {
        ...
        case sport(EveryMatrix.SportDTO)
        case match(EveryMatrix.MatchDTO)
        case market(EveryMatrix.MarketDTO)
        case outcome(EveryMatrix.OutcomeDTO)
        case bettingOffer(EveryMatrix.BettingOfferDTO)
        case location(EveryMatrix.LocationDTO)
        case eventCategory(EveryMatrix.EventCategoryDTO)
        case marketOutcomeRelation(EveryMatrix.MarketOutcomeRelationDTO)
        case mainMarket(EveryMatrix.MainMarketDTO)
        case marketInfo(EveryMatrix.MarketInfoDTO)
        case nextMatchesNumber(EveryMatrix.NextMatchesNumberDTO)
        case tournament(EveryMatrix.TournamentDTO)
        case eventInfo(EveryMatrix.EventInfoDTO)
        case marketGroup(EveryMatrix.MarketGroupDTO)

        // UPDATE/DELETE/CREATE records with change metadata
        case changeRecord(EveryMatrix.ChangeRecord)

...
//  
//
//  Created by André Lascas on 16/05/2023.
//
...
class OptionRadioView: UIView {
    ...
    var isChecked: Bool = false {
        didSet {
            if isChecked {
                self.radioImageView.layer.borderColor = AppColor.highlightPrimary.cgColor
                self.radioImageView.backgroundColor = AppColor.highlightPrimary
                ...
                self.radioImageView.tintColor = AppColor.buttonTextPrimary
            }
            else {
                self.radioImageView.layer.borderColor = AppColor.separatorLine.cgColor
                self.radioImageView.backgroundColor = AppColor.backgroundSecondary

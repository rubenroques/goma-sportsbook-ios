...
struct TargetVariables: SportsbookTarget {
    ...
    static var api: URLEndpoint.APIs {
        URLEndpoint.APIs(
            ...
            sportsbook: "https://gomasports.betsson.fr",
            firebase: "https://goma-sportsbook-gomasports.europe-west1.firebasedatabase.app/",
            casino: "https://sportsbook-cms.gomagaming.com/casino/",
            promotions: "https://gomasports.betsson.fr"
        )
    }

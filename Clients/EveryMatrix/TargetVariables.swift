...
struct TargetVariables: SportsbookTarget {
    ...
    static var homeTemplateBuilder: HomeTemplateBuilderType {
        return HomeTemplateBuilderType.backendDynamic(clientTemplateKey: "everymatrix")
    }
    ...
    static var api: URLEndpoint.APIs {
        URLEndpoint.APIs(
            ...
            sportsbook: "https://everymatrix.betsson.fr",
            firebase: "https://goma-sportsbook-everymatrix.europe-west1.firebasedatabase.app/",
            casino: "https://sportsbook-cms.gomagaming.com/casino/",
            promotions: "https://everymatrix.betsson.fr"
        )
    }

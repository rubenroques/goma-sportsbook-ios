...
struct TargetVariables: SportsbookTarget {
    ...
    static var api: URLEndpoint.APIs {
        URLEndpoint.APIs(
            ...
            sportsbook: "https://atp.betsson.fr",
            firebase: "https://goma-sportsbook-atp.europe-west1.firebasedatabase.app/",
            casino: "https://sportsbook-cms.gomagaming.com/casino/",
            promotions: "https://atp.betsson.fr"
        )
    }
    ...
    static var localizationOverrides: [String: String] {
        return [
            "anj_authorization_text": "ATP.COM est édité par ATP, société de droit maltais, titulaire des licences n# délivrées par l'ANJ le 01/01/2025",

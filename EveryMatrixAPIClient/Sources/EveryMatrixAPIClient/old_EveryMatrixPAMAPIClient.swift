...
public class old_EveryMatrixPAMAPIClient {
    ...
    public func getPlayersDocuments(playerId: Int64, xSessionid: String, xSessionType: String? = nil) async throws -> String {
        let endpoint = old_EveryMatrixPAMScheme.getPlayersDocuments(playerId: playerId, xSessionID: xSessionid, xSessionType: xSessionType)
    ...
    /// Async/await version
    public func getPlayerProfile(playerId: String, xSessionid: String, xSessionType: String? = nil) async throws -> String {
        let endpoint = old_EveryMatrixPAMScheme.getPlayerProfile(playerId: playerId, xSessionID: xSessionid, xSessionType: xSessionType)
        return try await networkClient.request(endpoint)
    }

    /// Combine publisher version
    public func getPlayerProfilePublisher(playerId: String, xSessionid: String, xSessionType: String? = nil) -> AnyPublisher<String, Error> {
        let endpoint = old_EveryMatrixPAMScheme.getPlayerProfile(playerId: playerId, xSessionID: xSessionid, xSessionType: xSessionType)
        return self.networkClient.requestPublisher(endpoint)
    }
    /// Async/await version
    public func putPlayerProfile(xSessionid: String, playerId: String, body: Any) async throws -> String {
        let endpoint = old_EveryMatrixPAMScheme.putPlayerProfile(playerId: playerId, xSessionID: xSessionid)
        return try await networkClient.request(endpoint)
    }

    /// Combine publisher version
    public func putPlayerProfilePublisher(xSessionid: String, playerId: String, body: Any) -> AnyPublisher<String, Error> {
        let endpoint = old_EveryMatrixPAMScheme.putPlayerProfile(playerId: playerId, xSessionID: xSessionid)
        return self.networkClient.requestPublisher(endpoint)
    }
    /// Async/await version
    public func postPlayerProfile(playerId: String, xSessionid: String, body: Any) async throws -> String {
        let endpoint = old_EveryMatrixPAMScheme.postPlayerProfile(playerId: playerId, xSessionID: xSessionid)
        return try await networkClient.request(endpoint)
    }

    /// Combine publisher version
    public func postPlayerProfilePublisher(playerId: String, xSessionid: String, body: Any) -> AnyPublisher<String, Error> {
        let endpoint = old_EveryMatrixPAMScheme.postPlayerProfile(playerId: playerId, xSessionID: xSessionid)
        return self.networkClient.requestPublisher(endpoint)
    }
    /// Async/await version
    public func getPlayersPlaymentLimits(playerId: Int64, xSessionid: String, xSessionType: String? = nil, pagination: String? = nil) async throws -> String {
        let endpoint = old_EveryMatrixPAMScheme.getPlayersPlaymentLimits(playerId: playerId, xSessionID: xSessionid, xSessionType: xSessionType, pagination: pagination)
        return try await networkClient.request(endpoint)
    }
    ...
    public func getPlayerGmcoreLimits(playerId: String, xSessionid: String, xSessionType: String? = nil) async throws -> String {
        let endpoint = old_EveryMatrixPAMScheme.getPlayerGmcoreLimits(playerId: playerId, xSessionID: xSessionid, xSessionType: xSessionType)
        return try await networkClient.request(endpoint)
    }
    ...
    /// Async/await version
    public func registerPlayer() async throws -> String {
        let endpoint = old_EveryMatrixPAMScheme.registerPlayer
        return try await networkClient.request(endpoint)
    }

    /// Combine publisher version
    public func registerPlayer() -> AnyPublisher<String, Error> {
        let endpoint = old_EveryMatrixPAMScheme.registerPlayer
        return self.networkClient.requestPublisher(endpoint)
    }
    /// Async/await version
    public func quickRegisterPlayer() async throws -> String {
        let endpoint = old_EveryMatrixPAMScheme.quickRegisterPlayer
        return try await networkClient.request(endpoint)
    }

    /// Combine publisher version
    public func quickRegisterPlayer() -> AnyPublisher<String, Error> {
        let endpoint = old_EveryMatrixPAMScheme.quickRegisterPlayer
        return self.networkClient.requestPublisher(endpoint)
    }
    /// Async/await version
    ...
    public func getPlayerPaymentSession(playerId: String, xSessionid: String, nwaClientIp: String? = nil, body: Any) async throws -> String {
        let endpoint = old_EveryMatrixPAMScheme.getPlayerPaymentSession(playerId: playerId, xSessionID: xSessionid, nwaClientIp: nwaClientIp)
        return try await networkClient.request(endpoint)
    }
    ...
    /// Async/await version
    public func postPlayerChangePlayerPassword(xSessionid: String, playerId: String, body: Any) async throws -> String {
        let endpoint = old_EveryMatrixPAMScheme.postPlayerChangePlayerPassword(playerId: playerId, xSessionID: xSessionid)
        return try await networkClient.request(endpoint)
    }

    /// Combine publisher version
    public func postPlayerChangePlayerPasswordPublisher(xSessionid: String, playerId: String, body: Any) -> AnyPublisher<String, Error> {
        let endpoint = old_EveryMatrixPAMScheme.postPlayerChangePlayerPassword(playerId: playerId, xSessionID: xSessionid)
        return self.networkClient.requestPublisher(endpoint)
    }
    /// Async/await version
    public func getPlayerLimitDefinitionsPlayerId(playerId: String, xSessionid: String, xSessionType: String? = nil) async throws -> String {
        let endpoint = old_EveryMatrixPAMScheme.getPlayerLimitDefinitionsPlayerId(playerId: playerId, xSessionID: xSessionid, xSessionType: xSessionType)
        return try await networkClient.request(endpoint)
    }
    ...
    public func getPlayersLegislationUserConsents(playerId: String, xSessionid: String, xSessionType: String? = nil) async throws -> String {
        let endpoint = old_EveryMatrixPAMScheme.getPlayersLegislationUserConsents(playerId: playerId, xSessionID: xSessionid, xSessionType: xSessionType)
        return try await networkClient.request(endpoint)
    }
    ...
    public func getPlayerListUserConsent(playerId: String, xSessionid: String, xSessionType: String? = nil) async throws -> String {
        let endpoint = old_EveryMatrixPAMScheme.getPlayerListUserConsent(playerId: playerId, xSessionID: xSessionid, xSessionType: xSessionType)
        return try await networkClient.request(endpoint)
    }
    ...
    public func postPlayerSmsTokenGenerate(body: Any) async throws -> String {
        let endpoint = old_EveryMatrixPAMScheme.postPlayerSmsTokenGenerate
        return try await networkClient.request(endpoint)
    }
    ...
    /// Async/await version
    public func getPlayerWallet(playerId: String, xSessionid: String) async throws -> String {
        let endpoint = old_EveryMatrixPAMScheme.getPlayerWallet(playerId: playerId, xSessionid)
        return try await networkClient.request(endpoint)
    }

    /// Combine publisher version
    public func getPlayerWalletPublisher(playerId: String, xSessionid: String) -> AnyPublisher<String, Error> {
        let endpoint = old_EveryMatrixPAMScheme.getPlayerWallet(playerId: playerId, xSessionid)
        return self.networkClient.requestPublisher(endpoint)
    }
    /// Async/await version
    ...
    public func deletePlayersBonusWallet(playerId: Int64, bonusWalletId: Int64, xSessionid: String, xSessionType: String? = nil) async throws -> String {
        let endpoint = old_EveryMatrixPAMScheme.deletePlayersBonusWallet(playerId: playerId, bonusWalletId, xSessionID: xSessionid, xSessionType: xSessionType)
        return try await networkClient.request(endpoint)
    }

...
class EveryMatrixAuthenticationErrorTests: XCTestCase {
    ...
    func testErrorDescriptions() {
        ...
        let decodingError = NSError(domain: "DecodingErrorDomain", code: 1, userInfo: [NSLocalizedDescriptionKey: "JSON decoding failed"])
    ...
    func testErrorEquality() {
        ...
        let error1 = NSError(domain: "TestDomain", code: 1, userInfo: [NSLocalizedDescriptionKey: "Error message"])
        let error2 = NSError(domain: "TestDomain", code: 1, userInfo: [NSLocalizedDescriptionKey: "Error message"])
        let error3 = NSError(domain: "TestDomain", code: 1, userInfo: [NSLocalizedDescriptionKey: "Different error"])
    ...
    func testErrorHandling() {
        ...
        func handleError(_ error: EveryMatrixAuthenticationError) -> String {
            ...
            case .invalidResponseDecoded(let error):
                return "Response parsing issue: \(error.localizedDescription)"
        ...
        let decodingError = NSError(domain: "DecodingErrorDomain", code: 1, userInfo: [NSLocalizedDescriptionKey: "JSON parse error"])

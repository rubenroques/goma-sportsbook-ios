...
protocol PrivilegedAccessManager {
    ...
    func getTransactionsHistory(startDate: String, endDate: String, transactionTypes: [TransactionTypes]?, pageNumber: Int?) -> AnyPublisher<[TransactionDetail], ServiceProviderError>

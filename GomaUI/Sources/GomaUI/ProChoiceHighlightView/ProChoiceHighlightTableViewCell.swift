...
class ProChoiceHighlightTableViewCell: UITableViewCell {
    ...
    private var colorScheme: ColorScheme = DefaultColorScheme.shared {
        didSet {
            self.setupWithTheme()
        }
    }
    ...
    private func setupWithTheme() {
        ...
        self.containerView.backgroundColor = self.colorScheme.backgroundPrimary

        self.leagueNameLabel.textColor = self.colorScheme.textPrimary
        self.eventDateLabel.textColor = self.colorScheme.textPrimary
        self.eventTimeLabel.textColor = self.colorScheme.textPrimary
        self.teamsLabel.textColor = self.colorScheme.textPrimary
    }
    ...
    func configure(with viewModel: ProChoiceHighlightViewModel) {
        ...
        self.eventImageView.image = UIImage(named: "dummyPlaceholder", in: Bundle.module, with: nil)

        self.favoriteImageView.image = UIImage(named: "selected_favorite_icon", in: Bundle.module, with: nil)
    }
...
extension ProChoiceHighlightTableViewCell {
    ...
    private func createContainerView() -> UIView {
        let view = UIView()
        view.backgroundColor = self.colorScheme.backgroundPrimary
    ...
    private func createLeagueNameLabel() -> UILabel {
        ...
        label.textColor = self.colorScheme.textPrimary
    ...
    private func createSeeAllMarketsButton() -> UIButton {
        ...
        button.backgroundColor = self.colorScheme.buttonBackgroundPrimary
...
private class PreviewTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.configure(with: ProChoiceHighlightViewModel(
            ...
            drawOdds: "3.2",
            awayOdds: "2.8",
            eventInfoHeaderBarViewModel: EventInfoHeaderBarViewModel.debug)
        )

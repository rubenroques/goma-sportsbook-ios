...
public struct DynamicColorHex: Codable {
...
public struct StyleProviderColors: Codable {
    // Highlights colors
...
extension StyleProviderColors {
    static let defaultColors = StyleProviderColors(
        ...
        backgroundPrimary: DynamicColorHex(light: "#F2F2F7", dark: "#000000"),
        backgroundSecondary: DynamicColorHex(light: "#FFFFFF", dark: "#1C1C1E"),
        backgroundTertiary: DynamicColorHex(light: "#FFFFFF", dark: "#2C2C2E"),
        backgroundBorder: DynamicColorHex(light: "#C6C6C8", dark: "#38383A"),
        backgroundCards: DynamicColorHex(light: "#FFFFFF", dark: "#1C1C1E"),
        appBottomMenu: DynamicColorHex(light: "#F2F2F7", dark: "#1C1C1E"),
        separatorLine: DynamicColorHex(light: "#C6C6C8", dark: "#38383A"),
        separatorLineSecondary: DynamicColorHex(light: "#E5E5EA", dark: "#48484A"),
        separatorLineHighlightPrimary: DynamicColorHex(light: "#FF6600", dark: "#FF6600"),
        separatorLineHighlightSecondary: DynamicColorHex(light: "#40B840", dark: "#40B840"),
        textPrimary: DynamicColorHex(light: "#000000", dark: "#FFFFFF"),
        textSecondary: DynamicColorHex(light: "#3C3C43", dark: "#EBEBF5"),
        textHeadlinePrimary: DynamicColorHex(light: "#000000", dark: "#FFFFFF"),
        textDisablePrimary: DynamicColorHex(light: "#8E8E93", dark: "#8E8E93"),
        textTopbar: DynamicColorHex(light: "#000000", dark: "#FFFFFF"),
        backgroundOdds: DynamicColorHex(light: "#F2F2F7", dark: "#2C2C2E"),
        textOdds: DynamicColorHex(light: "#000000", dark: "#FFFFFF"),
        textDisabledOdds: DynamicColorHex(light: "#8E8E93", dark: "#8E8E93"),
        backgroundDisabledOdds: DynamicColorHex(light: "#E5E5EA", dark: "#48484A"),
        iconPrimary: DynamicColorHex(light: "#000000", dark: "#FFFFFF"),
        iconSecondary: DynamicColorHex(light: "#3C3C43", dark: "#EBEBF5"),
        inputBackground: DynamicColorHex(light: "#FFFFFF", dark: "#1C1C1E"),
        inputBackgroundSecondary: DynamicColorHex(light: "#F2F2F7", dark: "#2C2C2E"),
        inputBorderActive: DynamicColorHex(light: "#FF6600", dark: "#FF6600"),
        inputError: DynamicColorHex(light: "#FF3B30", dark: "#FF453A"),
        inputBackgroundDisable: DynamicColorHex(light: "#E5E5EA", dark: "#48484A"),
        inputBorderDisabled: DynamicColorHex(light: "#C6C6C8", dark: "#38383A"),
        inputTextTitle: DynamicColorHex(light: "#3C3C43", dark: "#EBEBF5"),
        inputText: DynamicColorHex(light: "#000000", dark: "#FFFFFF"),
        inputTextTitleDisable: DynamicColorHex(light: "#8E8E93", dark: "#8E8E93"),
        inputTextDisable: DynamicColorHex(light: "#8E8E93", dark: "#8E8E93"),
        navPills: DynamicColorHex(light: "#F2F2F7", dark: "#2C2C2E"),
        pills: DynamicColorHex(light: "#E5E5EA", dark: "#48484A"),
        settingPill: DynamicColorHex(light: "#FFFFFF", dark: "#1C1C1E"),
        backgroundDrop: DynamicColorHex(light: "#FFFFFF", dark: "#1C1C1E"),
        borderDrop: DynamicColorHex(light: "#C6C6C8", dark: "#38383A"),
        navBannerActive: DynamicColorHex(light: "#FF6600", dark: "#FF6600"),
        navBanner: DynamicColorHex(light: "#F2F2F7", dark: "#2C2C2E"),
        buttonTextPrimary: DynamicColorHex(light: "#FFFFFF", dark: "#FFFFFF"),
        buttonTextSecondary: DynamicColorHex(light: "#FFFFFF", dark: "#FFFFFF"),
        buttonBackgroundPrimary: DynamicColorHex(light: "#FF6600", dark: "#FF6600"),
        buttonActiveHoverPrimary: DynamicColorHex(light: "#E55A00", dark: "#E55A00"),
        buttonDisablePrimary: DynamicColorHex(light: "#C6C6C8", dark: "#38383A"),
        buttonTextDisablePrimary: DynamicColorHex(light: "#8E8E93", dark: "#8E8E93"),
        buttonBackgroundSecondary: DynamicColorHex(light: "#007AFF", dark: "#0A84FF"),
        buttonActiveHoverSecondary: DynamicColorHex(light: "#0056CC", dark: "#0056CC"),
        buttonDisableSecondary: DynamicColorHex(light: "#C6C6C8", dark: "#38383A"),
        buttonTextDisableSecondary: DynamicColorHex(light: "#8E8E93", dark: "#8E8E93"),
        buttonBackgroundTertiary: DynamicColorHex(light: "#F2F2F7", dark: "#2C2C2E"),
        buttonTextTertiary: DynamicColorHex(light: "#007AFF", dark: "#0A84FF"),
        buttonBorderTertiary: DynamicColorHex(light: "#007AFF", dark: "#0A84FF"),
        buttonActiveHoverTertiary: DynamicColorHex(light: "#E5E5EA", dark: "#48484A"),
        buttonBorderDisableTertiary: DynamicColorHex(light: "#C6C6C8", dark: "#38383A"),
        buttonTextDisableTertiary: DynamicColorHex(light: "#8E8E93", dark: "#8E8E93"),
        alertError: DynamicColorHex(light: "#FF3B30", dark: "#FF453A"),
        alertSuccess: DynamicColorHex(light: "#34C759", dark: "#30D158"),
        alertWarning: DynamicColorHex(light: "#FF9500", dark: "#FF9F0A"),
        myTicketsLostFaded: DynamicColorHex(light: "#8E8E93", dark: "#8E8E93"),
        myTicketsWon: DynamicColorHex(light: "#34C759", dark: "#30D158"),
        myTicketsWonFaded: DynamicColorHex(light: "#8E8E93", dark: "#8E8E93"),
        myTicketsOther: DynamicColorHex(light: "#FF9500", dark: "#FF9F0A"),
        myTicketsLost: DynamicColorHex(light: "#FF3B30", dark: "#FF453A"),
        statsAway: DynamicColorHex(light: "#007AFF", dark: "#0A84FF"),
        statsHome: DynamicColorHex(light: "#FF6600", dark: "#FF6600"),
        shadow: DynamicColorHex(light: "#000000", dark: "#000000"),
        shadowMedium: DynamicColorHex(light: "#000000", dark: "#000000"),
        shadowDarker: DynamicColorHex(light: "#000000", dark: "#000000"),
        scroll: DynamicColorHex(light: "#C6C6C8", dark: "#38383A"),
        bubblesPrimary: DynamicColorHex(light: "#FF6600", dark: "#FF6600"),
        menuSelector: DynamicColorHex(light: "#FF6600", dark: "#FF6600"),
        menuSelectorHover: DynamicColorHex(light: "#E55A00", dark: "#E55A00"),
        allWhite: DynamicColorHex(light: "#FFFFFF", dark: "#FFFFFF"),
        allDark: DynamicColorHex(light: "#000000", dark: "#000000"),
        favorites: DynamicColorHex(light: "#FFCC00", dark: "#FFD60A"),
        liveTag: DynamicColorHex(light: "#34C759", dark: "#30D158"),
        textHeroCard: DynamicColorHex(light: "#FFFFFF", dark: "#FFFFFF"),
        textSecondaryHeroCard: DynamicColorHex(light: "#EBEBF5", dark: "#EBEBF5"),
        iconSportsHeroCard: DynamicColorHex(light: "#FFFFFF", dark: "#FFFFFF"),
        backgroundOddsHeroCard: DynamicColorHex(light: "#007AFF", dark: "#0A84FF"),
        backgroundBetslip: DynamicColorHex(light: "#F2F2F7", dark: "#1C1C1E"),
        addBetslip: DynamicColorHex(light: "#FF6600", dark: "#FF6600"),
        gameHeaderTextPrimary: DynamicColorHex(light: "#000000", dark: "#FFFFFF"),
        gameHeaderTextSecondary: DynamicColorHex(light: "#3C3C43", dark: "#EBEBF5"),
        gameHeader: DynamicColorHex(light: "#F2F2F7", dark: "#1C1C1E"),
        cardBorderLineGradient1: DynamicColorHex(light: "#FF6600", dark: "#FF6600"),
        cardBorderLineGradient2: DynamicColorHex(light: "#FF9500", dark: "#FF9F0A"),
        cardBorderLineGradient3: DynamicColorHex(light: "#FFCC00", dark: "#FFD60A"),
        boostedOddsGradient1: DynamicColorHex(light: "#FF6600", dark: "#FF6600"),
        boostedOddsGradient2: DynamicColorHex(light: "#FFCC00", dark: "#FFD60A"),
        backgroundGradientDark: DynamicColorHex(light: "#000000", dark: "#000000"),
        backgroundGradientLight: DynamicColorHex(light: "#FFFFFF", dark: "#FFFFFF"),
        backgroundGradient1: DynamicColorHex(light: "#F2F2F7", dark: "#1C1C1E"),
        backgroundGradient2: DynamicColorHex(light: "#FFFFFF", dark: "#2C2C2E"),
        topBarGradient1: DynamicColorHex(light: "#FF6600", dark: "#FF6600"),
        topBarGradient2: DynamicColorHex(light: "#FF9500", dark: "#FF9F0A"),
        topBarGradient3: DynamicColorHex(light: "#FFCC00", dark: "#FFD60A"),
        liveBorder1: DynamicColorHex(light: "#FF6600", dark: "#FF6600"),
        liveBorder2: DynamicColorHex(light: "#FF9500", dark: "#FF9F0A"),
        liveBorder3: DynamicColorHex(light: "#007AFF", dark: "#0A84FF"),
        messageGradient1: DynamicColorHex(light: "#007AFF", dark: "#0A84FF"),
        messageGradient2: DynamicColorHex(light: "#34C759", dark: "#30D158"),
        backgroundEmptySuccess1: DynamicColorHex(light: "#34C759", dark: "#30D158"),
        backgroundEmptySuccess2: DynamicColorHex(light: "#40C759", dark: "#40D158"),
        backgroundEmptySuccess3: DynamicColorHex(light: "#4CC759", dark: "#50D158"),
        backgroundEmptyWinner1: DynamicColorHex(light: "#FFCC00", dark: "#FFD60A"),
        backgroundEmptyWinner2: DynamicColorHex(light: "#FFD000", dark: "#FFD60A"),
        backgroundEmptyWinner3: DynamicColorHex(light: "#FFD400", dark: "#FFD60A"),
        backgroundEmptyMessage1: DynamicColorHex(light: "#007AFF", dark: "#0A84FF"),
        backgroundEmptyMessage2: DynamicColorHex(light: "#1084FF", dark: "#1A84FF"),
        backgroundEmptyMessage3: DynamicColorHex(light: "#2094FF", dark: "#2A84FF")
    )
}

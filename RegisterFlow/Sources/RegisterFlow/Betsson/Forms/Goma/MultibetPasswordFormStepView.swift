//
//  MultibetPasswordFormStepView.swift
//
//
...
class MultibetPasswordFormStepViewModel {
...
class MultibetPasswordFormStepView: FormStepView {
    ...
    private let viewModel: MultibetPasswordFormStepViewModel
    private var cancellables = Set<AnyCancellable>()
    ...
    init(viewModel: MultibetPasswordFormStepViewModel) {
...
extension MultibetPasswordFormStepView {
